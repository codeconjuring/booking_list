        ...
        <div class="col-md-6 grid-margin stretch-card">
          <div class="card">
            <div class="card-body">
              ...
              <form class="forms-sample" action="{{ route('admin.form-builder.update',$formBuilder) }}" method="POST">
                @csrf
                @method('put')
                ...
                <div class="form-group">
                    ...
                    <p>Dropdown <input type="radio" {{ $formBuilder->type=='1'?'checked':'' }} name="type" value="1"> Text <input type="radio" {{ $formBuilder->type=='0'?'checked':'' }} name="type" value="0"></p>
