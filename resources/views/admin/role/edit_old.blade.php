                ...
                @method('PUT')
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control ic_custom-form-input" id="ic_role_name" autocomplete="off" name="role_name" placeholder="Enter Role Name" required value="{{$role->name}}">
                        </div>
