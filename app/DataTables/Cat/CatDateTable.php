...
class CatDateTable extends DataTable
{
    /**
        ...
        return datatables()
            ...
            ->addColumn('action', function ($category) {
                ...
                if ($authUser->can('Edit Book Attributes Series')) {
                    $buttons .= '<a class="dropdown-item text-success" href="' . route('admin.category.edit',
                        $category->id) . '" title="Edit Category">
                        <i class="fas fa-edit"></i>&nbsp;Edit
                    </a>';
                }
                if ($authUser->can('Delete Book Attributes Series')) {
                    $buttons .= '<form action="' . route('admin.category.destroy', $category->id) . '"  id="deleteForm' . $category->id . '" method="post" style="display: none">
