        ...
        return datatables()
            ...
            ->addColumn('action', function ($author) {
                ...
                if ($authUser->can('Edit Book Attributes Series')) {
                    $buttons .= '<a class="dropdown-item text-success" href="' . route('admin.author.edit',
                ...
                <a href="javascript:void(0)" class="dropdown-item text-danger" onclick="makeDeleteRequest(event, ' . $author->id . ')" title="Delete Role"><i class="fas fa-trash"></i>&nbsp;Delete</a>';
                }
