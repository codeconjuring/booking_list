      ...
      <div class="col-xxl-12 col-12 m-auto">
               ...
               <div class="row">
                  <div class="col-lg-5 col-md-5">
                     ...
                     <div class="cc-count-app">
                        ...
                        <div class="cc-count-items" style="padding: 10px">
                           <i class="icon-list"></i>
                           <div>
                              <p class="cc-number mb-0 my-2" style="font-size: 26px;">
                  ...
                  <div class="col-lg-7 col-md-7">
                     <div class="cc-books-details-content">
                        <h3>{{ $book->title }}<a href="{{ route('admin.form.edit',$book->id) }}" class="btn-sm btn-warning text-white float-right">Edit</a>
                        </h3>
                        <table class="table table-borderless books-details-table">
                           ...
                           @endif
                           @if(sizeof($book->bookFormatInfos) > 0)
                           <tr>
                              <td>
                                 <span>
                                    Price 
                              ...
                              <td>
                                 <div class="cc-formate">
                                    @foreach($book->bookFormatInfos as $format)
                                    @if(strtolower($format->formbuilders->label) != 'gfp' and array_key_exists($format->formbuilders->id, $formats))
                                    @if(strtolower($format->formbuilders->label) == 'ebook')
                                    <span class="ic-ebook cc-badege dollar">
                                    @elseif(strtolower($format->formbuilders->label) == 'audio')
                                    <span class="cc-badege ic-adiuo dollar">
                                    @elseif(strtolower($format->formbuilders->label) == 'pod-h' or strtolower($format->formbuilders->label) == 'pod-s')
                                    <span class="ic-pod cc-badege dollar">
                                    @endif
                                    {{ $format->formbuilders->label }} : ${{ $format->price  }}
                                    </span>
                                    @endif
                                    @endforeach
                                 </div>
         ...
         <div class="cc-books-slider-main-heads mt-5">
            ...
            <div class="ic-books-slider owl-carousel owl-theme">
               ...
               <a href="{{route('admin.form.get-book-details',['id'=>$same_series_suggestion->id]) }}">
